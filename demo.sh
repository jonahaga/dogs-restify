...
curl -i -w '\n\n' -X GET http://localhost:8000/dogs;
curl -i -w '\n\n' -X PUT http://localhost:8000/dogs/Hildi -d '{"name":"Hildi", "breed":"Dacshund", "status": "hungry", "color": "red"}';
curl -i -w '\n\n' -X GET http://localhost:8000/dogs;
curl -i -w '\n\n' -X PUT http://localhost:8000/dogs/Hugo -d '{"name":"Hugo", "breed":"Dacshund", "color": "red"}';
